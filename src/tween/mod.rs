//! Tween — smooth value interpolation with easing functions.
//!
//! # Quick start
//! ```
//! use nene::tween::{Tween, Ease, TweenLoop};
//!
//! // Animate a float from 0 → 1 in 0.5 s with a cubic ease-out, then ping-pong.
//! let mut t = Tween::new(0.0_f32, 1.0, 0.5)
//!     .with_ease(Ease::CubicOut)
//!     .with_loop(TweenLoop::PingPong);
//!
//! // In your update callback:
//! let v = t.update(1.0 / 60.0);
//! assert!(v >= 0.0 && v <= 1.0);
//! ```
