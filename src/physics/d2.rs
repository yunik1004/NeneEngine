...
impl BodyBuilder {
    ...
    pub fn angvel(self, v: f32) -> Self { Self(self.0.angvel(v)) }
...
impl ColliderBuilder {
    ...
    pub fn cuboid(hx: f32, hy: f32) -> Self { Self(r::ColliderBuilder::cuboid(hx, hy)) }
...
impl World {
    pub fn new() -> Self { Self::with_gravity([0.0, -9.81]) }
