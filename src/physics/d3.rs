...
pub struct RigidBodyBuilder(rapier3d::prelude::RigidBodyBuilder);

impl RigidBodyBuilder {
    pub fn dynamic() -> Self {
        Self(rapier3d::prelude::RigidBodyBuilder::dynamic())
    }
    pub fn fixed() -> Self {
        Self(rapier3d::prelude::RigidBodyBuilder::fixed())
    }
    pub fn kinematic_position_based() -> Self {
        Self(rapier3d::prelude::RigidBodyBuilder::kinematic_position_based())
    }
    pub fn kinematic_velocity_based() -> Self {
        Self(rapier3d::prelude::RigidBodyBuilder::kinematic_velocity_based())
    }
...
/// 3D physics world. Manages rigid bodies, colliders, and simulation stepping.
pub struct World {
    bodies: RigidBodySet,
...
impl World {
    ...
    pub fn step(&mut self) {
        let gravity =
            rapier3d::math::Vector::new(self.gravity[0], self.gravity[1], self.gravity[2]);
        self.pipeline.step(
            gravity,
            &self.params,
            &mut self.islands,
